    ...
    items: [
      {
        ...
        to: "/dashboard/users",
        label: "Cuentas",
        icon: <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M4 6h16M4 12h16M4 18h16" /><path d="M8 6v12" /></svg>
      },
      {
        id: "new-clients",
